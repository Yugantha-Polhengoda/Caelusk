        ...
        <div class="custom-container">
            <div class="hero-inner">
                ...
                <div class="hero-bottom">
                    <div class="left">
                        <h2><?php esc_html_e( 'Archives', 'aixor' )?></h2>
                        <h2><?php
                                if ( is_day() ) :
                                    esc_html_e( ' DAILY ARCHIVES: ', 'aixor' );

                                elseif ( is_month() ) :
                                    esc_html_e( ' MONTHLY ARCHIVES: ', 'aixor' );


                                elseif ( is_year() ) :
                                    esc_html_e( ' YEARLY ARCHIVES: ', 'aixor' );
