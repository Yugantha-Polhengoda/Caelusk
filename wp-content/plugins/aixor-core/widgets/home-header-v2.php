...
class aixorHomeHeaderV2 extends Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Header V2', 'aixor-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'notch_section',
            [
                'label' => esc_html__('Notch Menu Section', 'aixor-core'),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            'notch_link',
            [
                'label'       => esc_html__('Notch Menu', 'aixor-core'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'notchbar_switcher_options',
            [
                'type'     => \Elementor\Controls_Manager::SWITCHER,
                'label'    => esc_html__( 'Notch Bar Controls', 'aixor-core' ),
                'default'  => 'yes', // Default value is 'true' for showing the menu
                'label_on'      => __( 'Show', 'aixor-core' ),
                'label_off'     => __( 'Hide', 'aixor-core' ),
                'return_value'  => 'yes',
        ...
        $this->add_control(
            'list2', //repeater name
            [
                'label'     => esc_html__( 'Bar List', 'aixor-core' ),
                'type'      => \Elementor\Controls_Manager::REPEATER,
                'fields'    => $repeater->get_controls(),
                'default'   => [
                    [
                ...
                'title_field' => '{{{ notch_link }}}', // Reapeter Title 
            ]
        );
    ...
    protected function render()
    {
        ...
        <div class="home-v2 scroll-to-show-menu">
        ...
        <!-- ===== Notch Bar Menu Start ===== -->
        <?php if ($settings['notchbar_switcher_options'] === 'yes') : ?>
            <div class="notch-bar-menu-wrap">
                <ul>
                    <?php if(!empty($settings['list2'])):
                                foreach ($settings['list2'] as $index => $settings_loop):?>
                        <li><a class="anchor" href="<?php echo esc_attr($settings_loop['notch_link']); ?>"></a></li>
                ...
                <div class="header-sidebar-bottom">
                    <ul>
                        <?php if(!empty($settings['list3'])):
                            foreach ($settings['list3'] as $index => $settingsicon_loop):?>
                ...
                <div class="custom-row">
                    ...
                    <nav class="navbar">
                        <ul class="menu">
                            ...
                            <?php if(!empty($settings['list4'])):
                                foreach ($settings['list4'] as $index => $settings2_loop):?>
